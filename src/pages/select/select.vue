<template>
  <div>
    <vp-layout-page>
      <vp-header-sort :navbars="navbars" :filters="filters" :types="goodsTypes" @change="sortChange" @typesChange="typesChange" @filtersSubmit="filtersSubmit"
        slot="header"></vp-header-sort>
  ...
  export default {
    ...
    methods: {
      ...
      typesChange(params) {//选择的分类有改变,根据分类刷新品牌和商品
        ...
        this.request = {...this.request, appCategoryIds: typeIds}
        this.up(true);
      },
