                ...
                <div class="popup0">
                    <div class="goods vux-1px-b">
                        <div class="thumbnail-box">
                          <img v-lazy="goodsThumbnail" @click="$emit('thumbnailClick')" class="thumbnail">
                        </div>
                        <div class="goods-info">
                            <p class="goods-info-title row-2-ellipsis">{{ goodsTitle }}</p>
                    ...
                    <div class="scroll-wrapper">
                        <div class="sku">
                            <div class="sku-box vux-1px-b" v-for="(item1, index1) in keysObj" :key="index1">
                        ...
                        <div class="count">
                            ...
                            <vp-input-number v-model="count" :minValue="selectedVal.stock*1 > 0 ? 1 : 0" :maxValue="selectedVal.stock*1 > 0 ? selectedVal.stock*1 : 0"></vp-input-number>
                        </div>
                        <slot></slot>
                    </div>
                    <div class="btn-wrapper" @click="submit">
                        <vp-button :content="btnText"></vp-button>
                    </div>
                </div>
            </div>
        <!--</popup>-->
...
import vpButton from '@/components/button/button';
import vpInputNumber from '@/components/input/input-number';
export default {
    props: {
        btnText: {
            type: String,
    ...
    data() {
        return {
            defaultImg: require('@/assets/images/default/156x156.png'),
            keysObj: {},
            avalibleObj: {},
            SKUResult: {},
            path: [],
    ...
    methods: {
        ...
        selectedHandler(key, index) {//点击回调
            ...
            let path = [];
            let curId = newObj[key][index].id;//当前点击項的id
