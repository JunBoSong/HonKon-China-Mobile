<template>
  ...
  <section>
    ...
    <div class="slectRight">
        <group  @click.native="handleClickI()">
    ...
    <div class="slectRight">
        <group  @click.native="handleClickII()">
    ...
    <!-- <vp-input-message label="大廈名稱" placeholder="請輸入大廈名稱" v-model="addressObj.bldgTcResult" label-width="1.4rem" /> -->
     <div class="slectRight">
        <group  @click.native="handleClickIII()">
...
import { Group,PopupPicker } from 'vux'
  export default {
    ...
    methods: {
      handleClickI(){
        console.log("dianjilediyi1")

      },
       handleClickII(){
        console.log("dianjilediyi2", `${this.addressObj.areaTcResult || ''}${this.addressObj.districtTcResult || ''}${this.valueI[0]}`)
        let str2= `${this.valueI[0]}` || ""
        // this.submitSearchII(val[0],2)
        this.submitSearchII(str2,2)
      },
       handleClickIII(){
         let str3= `${this.valueI[0]}${(this.valueII && this.valueII[0]) || ""}`
         this.submitSearchII(str3,3)
        console.log("dianjilediyi3")
